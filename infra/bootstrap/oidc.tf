...
# Deploy needs to manage the platform's services. Broad for the MVP (a handful of stacks); tighten to
# resource ARNs once the resource set stabilises. iam:* is required to create the Lambda execution
# roles in infra/shared and the per-tenant roles in infra/tenant.
